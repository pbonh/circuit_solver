...
Family of linear multistep methods integrating the right-hand side over the last k step polynomial; Adams-Bashforth (explicit) and Adams-Moulton (implicit). Excellent for nonstiff problems.
