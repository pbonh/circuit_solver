...
Numerical method requiring a polynomial u(x) to satisfy u(x_n)=y_n and the ODE at collocation points; equivalent to an implicit Runge-Kutta method satisfying C(s).
