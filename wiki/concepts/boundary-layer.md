...
Thin region near the initial time where the solution of a singular perturbation problem changes rapidly to approach the slow manifold; captured by exponentially decaying terms eta(x/epsilon).
