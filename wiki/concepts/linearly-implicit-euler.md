---
title: "Linearly Implicit Euler Method"
type: concept
...
Discretisation (I - h*J)(y_{n+1} - y_n) = h*f(y_n); first-order base method for SEULEX extrapolation and Rosenbrock-type methods.
