...
Real function R(x) with R^(j)(x) >= 0 for all j on an interval; Bernstein (1928) characterises functions absolutely monotonic on (-inf, 0] as Laplace-Stieltjes transforms of non-decreasing measures.
