...
Property that the distance between two numerical trajectories does not increase; equivalent to B-stability when nu <= 0 in the one-sided Lipschitz condition.
