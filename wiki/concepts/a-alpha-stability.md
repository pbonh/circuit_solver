...
Widlund (1967) relaxation of A-stability: stability domain contains the sector |arg(-z)|<alpha. Permits high-order multistep methods (e.g., BDF k=3..6 with progressively smaller alpha).
